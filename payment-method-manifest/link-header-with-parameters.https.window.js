...
// META: title=Link header with additional parameters is parsed correctly
...
promise_test(async t => {
  ...
  const pmiUrl = createPaymentMethodIdentifierUrl(testId, { link: `<${manifestUrl}>; rel="payment-method-manifest"; foo=bar` });
