...
// META: title=Link header rel attribute supports space-separated relation tokens per RFC 8288
...
promise_test(async t => {
  ...
  const pmiUrl = createPaymentMethodIdentifierUrl(testId, { link: `<${manifestUrl}>; rel="other payment-method-manifest"` });
